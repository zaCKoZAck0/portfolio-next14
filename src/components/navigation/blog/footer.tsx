    ...
    <footer className="mt-36 rounded-xl bg-card text-card-foreground">
      <div className="max-w-7xl px-6 py-6">
        <div className="flex items-center gap-6">
          <Image
            className="size-20 flex-shrink-0 rounded-full border-2 border-orange-200"
            alt="zackozack"
            width={100}
            height={100}
          ...
          <div className="space-y-2">
            <h3 className="font-mono text-lg font-semibold text-white">About Me</h3>
            <p className="text-sm">
        ...
        {/* Copyright */}
        <div className="mt-6 flex justify-between border-t pt-6 text-center text-xs text-muted-foreground">
